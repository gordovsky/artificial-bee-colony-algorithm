...
namespace ABC
{
    public class Swarm
    {
        //delegate void RenderPointsDelegate(string input);
        ...
        public void Run()
        { 
            //for (int i = 0; i < Instance.Iterations; i++)
            //{
        ...
        //public void SendAgents(Point position, int index, int count)
        //{
        //    for (int i = 0; i< count; i++)
        //    {
                //var agent = Agents[index];
                //if (Swarm.Instance.BestPatches agent)
        //    }
        //}
